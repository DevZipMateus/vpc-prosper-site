...
const About = () => {
  return <section id="about" className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto mb-12 sm:mb-16 px-4 sm:px-0">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-2xl sm:text-3xl font-bold text-navy mb-3 sm:mb-4">Nossa História</h3>
            ...
            <div className="bg-gradient-navy-blue rounded-lg p-6 sm:p-8 text-white">
              <blockquote className="text-xl sm:text-2xl font-medium mb-3 sm:mb-4 bg-gray-950 rounded-xl p-4">
                "VPC Brasil: Construindo o amanhã, hoje."
              </blockquote>
              <p className="text-blue-light-soft text-zinc-950 text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 px-4 sm:px-0">
          <Card className="text-center hover-lift">
            <CardContent className="p-6 sm:p-8">
              <Target className="w-12 h-12 sm:w-16 sm:h-16 text-gold mx-auto mb-3 sm:mb-4" />
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Missão</h3>
          ...
          <Card className="text-center hover-lift">
            <CardContent className="p-6 sm:p-8">
              <Award className="w-12 h-12 sm:w-16 sm:h-16 text-gold mx-auto mb-3 sm:mb-4" />
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Visão</h3>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
          ...
          <Card className="text-center hover-lift">
            <CardContent className="p-6 sm:p-8">
              <Users className="w-12 h-12 sm:w-16 sm:h-16 text-gold mx-auto mb-3 sm:mb-4" />
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Valores</h3>
              <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
        ...
        <div className="bg-white rounded-lg p-6 sm:p-8 md:p-12 mx-4 sm:mx-0">
          <h3 className="text-2xl sm:text-3xl font-bold text-navy text-center mb-8 sm:mb-12">Os Pilares VPC</h3>
          
          <div className="space-y-8 sm:space-y-12">
            {/* Visão */}
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              <div className="flex-shrink-0">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-gold rounded-full flex items-center justify-center">
                  <span className="text-xl sm:text-2xl font-bold text-navy">V</span>
                </div>
              </div>
              <div className="flex-1 text-center md:text-left">
                <h4 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Visão</h4>
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              <div className="flex-shrink-0">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-gold rounded-full flex items-center justify-center">
                  <span className="text-xl sm:text-2xl font-bold text-navy">P</span>
                </div>
              </div>
              <div className="flex-1 text-center md:text-left">
                <h4 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Proteção</h4>
                <p className="text-muted-foreground text-sm sm:text-base lg:text-lg leading-relaxed">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              <div className="flex-shrink-0">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-gold rounded-full flex items-center justify-center">
                  <span className="text-xl sm:text-2xl font-bold text-navy">C</span>
                </div>
              </div>
              <div className="flex-1 text-center md:text-left">
                <h4 className="text-xl sm:text-2xl font-bold text-navy mb-3 sm:mb-4">Conforto</h4>
                <p className="text-muted-foreground text-sm sm:text-base lg:text-lg leading-relaxed">
